...
/**
 * Admin-curated catalog of how sellers can cash out their earnings.
 * Different providers / fees than the buyer-side top-up catalog.
 *
 * Per-user saved destinations (specific IBAN / wallet / PayPal address)
 * live in the separate PayoutMethod model.
 */
class PayoutMethodType extends Model
{
    protected $guarded = [];
    ...
    /**
     * Active payout types in display order.
     *
